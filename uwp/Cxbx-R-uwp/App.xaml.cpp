...
{
	// Establish the LocalFolder-backed writable area before any core component
	// is started. Only logs, saves/cache and explicitly materialized streams
	// are kept here; picked games remain in their original folders.
	create_task(UwpStorageBroker::InitializeAsync());
#if _DEBUG
