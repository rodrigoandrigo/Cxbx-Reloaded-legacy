...
void DX::DeviceResources::CreateDeviceIndependentResources()
{
	...
	// WIC was unused by this host template. Do not create it through COM:
	// CoCreateInstance is not part of the UWP API contract. New image loading
	// code must use Windows::Graphics::Imaging over a brokered StorageFile.
}
...
void DX::DeviceResources::Present() 
{
	...
	const UINT syncInterval = CxbxUwpGetD3D11Settings().verticalSync ? 1u : 0u;
	HRESULT hr = m_swapChain->Present1(syncInterval, 0, &parameters);
