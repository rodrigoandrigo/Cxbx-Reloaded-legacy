...
uintptr_t Cxbx_LibXbdmThunkTable[1 + 72] =
{
...
#define VARIABLE(v) v
	...
	(uintptr_t)FUNC(&xbdm::DmAllocatePool),                           // 0x0001 (1)
	(uintptr_t)FUNC(&xbdm::DmAllocatePoolWithTag),                    // 0x0002 (2)
	(uintptr_t)FUNC(&xbdm::DmCloseCounters),                          // 0x0003 (3)
	(uintptr_t)FUNC(&xbdm::DmCloseLoadedModules),                     // 0x0004 (4)
	(uintptr_t)FUNC(&xbdm::DmCloseModuleSections),                    // 0x0005 (5)
	(uintptr_t)FUNC(&xbdm::DmCloseNotificationSession),               // 0x0006 (6)
	(uintptr_t)FUNC(&xbdm::DmClosePerformanceCounter),                // 0x0007 (7)
	(uintptr_t)FUNC(&xbdm::DmContinueThread),                         // 0x0008 (8)
	(uintptr_t)FUNC(&xbdm::DmFreePool),                               // 0x0009 (9)
	(uintptr_t)FUNC(&xbdm::DmGetMemory),                              // 0x000A (10)
	(uintptr_t)FUNC(&xbdm::DmGetModuleLongName),                      // 0x000B (11)
	(uintptr_t)FUNC(&xbdm::DmGetProcAddress),                         // 0x000C (12)
	(uintptr_t)FUNC(&xbdm::DmGetThreadContext),                       // 0x000D (13)
	(uintptr_t)FUNC(&xbdm::DmGetThreadInfo),                          // 0x000E (14)
	(uintptr_t)FUNC(&xbdm::DmGetThreadList),                          // 0x000F (15)
	(uintptr_t)FUNC(&xbdm::DmGetXbeInfo),                             // 0x0010 (16)
	(uintptr_t)FUNC(&xbdm::DmGetXboxName),                            // 0x0011 (17)
	(uintptr_t)FUNC(&xbdm::DmGetXtlData),                             // 0x0012 (18)
	(uintptr_t)FUNC(&xbdm::DmGo),                                     // 0x0013 (19)
	(uintptr_t)FUNC(&xbdm::DmHaltThread),                             // 0x0014 (20)
	(uintptr_t)FUNC(&xbdm::DmIsDebuggerPresent),                      // 0x0015 (21)
	(uintptr_t)FUNC(&xbdm::DmIsThreadStopped),                        // 0x0016 (22)
	(uintptr_t)FUNC(&xbdm::DmLoadExtension),                          // 0x0017 (23)
	(uintptr_t)FUNC(&xbdm::DmNotify),                                 // 0x0018 (24)
	(uintptr_t)FUNC(&xbdm::DmOpenNotificationSession),                // 0x0019 (25)
	(uintptr_t)FUNC(&xbdm::DmOpenPerformanceCounter),                 // 0x001A (26)
	(uintptr_t)FUNC(&xbdm::DmQueryPerformanceCounterHandle),          // 0x001B (27)
	(uintptr_t)FUNC(&xbdm::DmReboot),                                 // 0x001C (28)
	(uint32_t)PANIC(0x001D),                                         // 0x001D (29)
	(uintptr_t)FUNC(&xbdm::DmRegisterCommandProcessor),               // 0x001E (30)
	(uint32_t)PANIC(0x001F),                                         // 0x001F (31)
	(uintptr_t)FUNC(&xbdm::DmRegisterNotificationProcessor),          // 0x0020 (32)
	(uintptr_t)FUNC(&xbdm::DmRegisterPerformanceCounter),             // 0x0021 (33)
	(uintptr_t)FUNC(&xbdm::DmRemoveBreakpoint),                       // 0x0022 (34)
	(uintptr_t)FUNC(&xbdm::DmResumeThread),                           // 0x0023 (35)
	(uintptr_t)FUNC(&xbdm::DmSendNotificationString),                 // 0x0024 (36)
	(uintptr_t)FUNC(&xbdm::DmSetBreakpoint),                          // 0x0025 (37)
	(uintptr_t)FUNC(&xbdm::DmSetDataBreakpoint),                      // 0x0026 (38)
	(uintptr_t)FUNC(&xbdm::DmSetInitialBreakpoint),                   // 0x0027 (39)
	(uintptr_t)FUNC(&xbdm::DmSetMemory),                              // 0x0028 (40)
	(uintptr_t)FUNC(&xbdm::DmSetThreadContext),                       // 0x0029 (41)
	(uintptr_t)FUNC(&xbdm::DmSetTitle),                               // 0x002A (42)
	(uintptr_t)FUNC(&xbdm::DmSetXboxName),                            // 0x002B (43)
	(uintptr_t)FUNC(&xbdm::DmStartProfile),                           // 0x002C (44)
	(uintptr_t)FUNC(&xbdm::DmStop),                                   // 0x002D (45)
	(uintptr_t)FUNC(&xbdm::DmStopOn),                                 // 0x002E (46)
	(uintptr_t)FUNC(&xbdm::DmStopProfile),                            // 0x002F (47)
	(uintptr_t)FUNC(&xbdm::DmSuspendThread),                          // 0x0030 (48)
	(uintptr_t)FUNC(&xbdm::DmThreadUserData),                         // 0x0031 (49)
	(uintptr_t)FUNC(&xbdm::DmUnloadExtension),                        // 0x0032 (50)
	(uintptr_t)FUNC(&xbdm::DmWalkLoadedModules),                      // 0x0033 (51)
	(uintptr_t)FUNC(&xbdm::DmWalkModuleSections),                     // 0x0034 (52)
	(uintptr_t)FUNC(&xbdm::DmWalkPerformanceCounters),                // 0x0035 (53)
	(uintptr_t)FUNC(&xbdm::PsGetCurrentThreadId),                     // 0x0036 (54)
	(uintptr_t)FUNC(&xbdm::DmEnableGPUCounter),                       // 0x0037 (55)
	(uintptr_t)FUNC(&xbdm::DmIsBreakpoint),                           // 0x0038 (56)
	(uintptr_t)FUNC(&xbdm::DmCloseUserList),                          // 0x0039 (57)
	(uintptr_t)FUNC(&xbdm::DmSetUserAccess),                          // 0x003A (58)
	(uintptr_t)FUNC(&xbdm::DmGetUserAccess),                          // 0x003B (59)
	(uintptr_t)FUNC(&xbdm::DmWalkUserList),                           // 0x003C (60)
	(uintptr_t)FUNC(&xbdm::DmAddUser),                                // 0x003D (61)
	(uintptr_t)FUNC(&xbdm::DmEnableSecurity),                         // 0x003E (62)
	(uintptr_t)FUNC(&xbdm::DmIsSecurityEnabled),                      // 0x003F (63)
	(uintptr_t)FUNC(&xbdm::DmRemoveUser),                             // 0x0040 (64)
	(uintptr_t)FUNC(&xbdm::_CAP_Start_Profiling),                     // 0x0041 (65)
	(uintptr_t)FUNC(&xbdm::_CAP_End_Profiling),                       // 0x0042 (66)
	(uintptr_t)FUNC(&xbdm::DmProfileControl),                         // 0x0043 (67)
	(uintptr_t)FUNC(&xbdm::_penter),                                  // 0x0044 (68)
	(uintptr_t)FUNC(&xbdm::_pexit),                                   // 0x0045 (69)
	(uintptr_t)FUNC(&xbdm::_CAP_Enter_Function),                      // 0x0046 (70)
	(uintptr_t)FUNC(&xbdm::_CAP_Exit_Function),                       // 0x0047 (71)
	(uintptr_t)FUNC(&xbdm::DmRegisterCommandProcessorEx),             // 0x0048 (72)
};
